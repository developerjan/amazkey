                ...
                <div class="m-content" id="mainBlock">
                    <div class="m-content">
                        <div class="step-container" id="site-form-container">
                            <form id="site-blocks" class="site-form" data-parsley-validate="">
                                <div class="row">
                                    @foreach($pages as $key => $page)
                                        <div class="col-md-3">
                                            <input type="checkbox" class="site-blocks-cb hidden" name="{{$page['name']}}" id="{{$page['id']}}" value="{{$page['name']}}" {{ $page['disable'] ? '' : 'checked' }}>
                                            <label class="image-cb-label" for="{{$page['id']}}">
                                                <span class="fa {{ $page['icon'] }}"></span>
                                                <p>{{$page['name']}}</p>
                                            </label>
                                        </div>
                                    @endforeach
